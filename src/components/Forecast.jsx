  ...
  return (
    <>
      <div className="w-full flex flex-col items-center justify-center pt-4">
        <div class="w-full max-w-sm p-8 flex justify-end gap-5">
        ...
        <ul className="w-full max-w-lg px-4 pb-8 grid grid-cols-[repeat(auto-fit,minmax(120px,1fr))] justify-items-center gap-5">
          <li className="w-full flex flex-col items-center gap-2 px-6 py-4 bg-[#1E213A] text-[#E7E7EB] rounded-lg">
            <p>Tomorrow</p>
